...
func LoginID(v string) predicate.User {
	return predicate.User(sql.FieldEQ(FieldLoginID, v))
}
...
func LoginIDContainsFold(v string) predicate.User {
	return predicate.User(sql.FieldContainsFold(FieldLoginID, v))
}
