...
func SoldOut(v bool) predicate.Item {
	return predicate.Item(sql.FieldEQ(FieldSoldOut, v))
}

// UserID applies equality check predicate on the "user_id" field. It's identical to UserIDEQ.
func UserID(v int) predicate.Item {
...
func SoldOutEQ(v bool) predicate.Item {
	return predicate.Item(sql.FieldEQ(FieldSoldOut, v))
}

// SoldOutNEQ applies the NEQ predicate on the "sold_out" field.
func SoldOutNEQ(v bool) predicate.Item {
	return predicate.Item(sql.FieldNEQ(FieldSoldOut, v))
}

// UserIDEQ applies the EQ predicate on the "user_id" field.
func UserIDEQ(v int) predicate.Item {
	return predicate.Item(sql.FieldEQ(FieldUserID, v))
}

// UserIDNEQ applies the NEQ predicate on the "user_id" field.
func UserIDNEQ(v int) predicate.Item {
	return predicate.Item(sql.FieldNEQ(FieldUserID, v))
}

// UserIDIn applies the In predicate on the "user_id" field.
func UserIDIn(vs ...int) predicate.Item {
	return predicate.Item(sql.FieldIn(FieldUserID, vs...))
}

// UserIDNotIn applies the NotIn predicate on the "user_id" field.
func UserIDNotIn(vs ...int) predicate.Item {
