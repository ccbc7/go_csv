...
func (_u *UserUpdate) SetLoginID(v string) *UserUpdate {
	_u.mutation.SetLoginID(v)
	return _u
}

// SetNillableLoginID sets the "login_id" field if the given value is not nil.
func (_u *UserUpdate) SetNillableLoginID(v *string) *UserUpdate {
	if v != nil {
		_u.SetLoginID(*v)
	}
	return _u
...
func (_u *UserUpdate) AddItemIDs(ids ...int) *UserUpdate {
...
func (_u *UserUpdate) RemoveItemIDs(ids ...int) *UserUpdate {
...
func (_u *UserUpdate) check() error {
	...
	if v, ok := _u.mutation.LoginID(); ok {
		if err := user.LoginIDValidator(v); err != nil {
			return &ValidationError{Name: "login_id", err: fmt.Errorf(`ent: validator failed for field "User.login_id": %w`, err)}
		}
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.LoginID(); ok {
		_spec.SetField(user.FieldLoginID, field.TypeString, value)
	}
...
// SetLoginID sets the "login_id" field.
func (_u *UserUpdateOne) SetLoginID(v string) *UserUpdateOne {
	_u.mutation.SetLoginID(v)
	return _u
}

// SetNillableLoginID sets the "login_id" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableLoginID(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetLoginID(*v)
	}
	return _u
...
// AddItemIDs adds the "items" edge to the Item entity by IDs.
func (_u *UserUpdateOne) AddItemIDs(ids ...int) *UserUpdateOne {
	_u.mutation.AddItemIDs(ids...)
	return _u
}
...
// RemoveItemIDs removes the "items" edge to Item entities by IDs.
func (_u *UserUpdateOne) RemoveItemIDs(ids ...int) *UserUpdateOne {
	_u.mutation.RemoveItemIDs(ids...)
	return _u
}
